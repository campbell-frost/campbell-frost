    ...
    data() {
        return {
            techList: [
                ...
                { image: "https://cdn.icon-icons.com/icons2/2415/PNG/512/php_plain_logo_icon_146397.png" },
            ],
        };
    },
    methods: {
        ...
        handleMouseDown(e) {
            const el = e.target;
            el.style.transform = 'perspective(500px) scale(0.7) rotateX(0) rotateY(0)';
        },
        handleMouseUp(e) {
            const el = e.target;
            el.style.transform = 'perspective(500px) scale(1.3) rotateX(0) rotateY(0)';
        },
    },
};
</script>
