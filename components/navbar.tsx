      ...
      <nav className=" bg-transparent py-1">
        <div className="container mx-auto">
          <div className="flex justify-between items-center">
            <InfoButton
              name="Campbell Frost"
              link="http://campbell-frost-next.vercel.app"
              bold={true}
            />
            <DropdownMenu>
              <DropdownMenuTrigger>
            ...
            <div className="hidden lg:flex lg:flex-grow lg:items-center lg:w-auto lg:justify-end">
              <div className="lg:flex lg:flex-row lg:ml-auto text-white text-lg">
                <InfoButton
                  name="Github"
                  link="https://github.com/campbell-frost"
                  bold={false}
                />
                <InfoButton
                  name="LinkedIn"
                  link="https://www.linkedin.com/in/campbell-frost-39656a207/"
                  bold={false}
                />
                <InfoButton
                  name="Instagram"
                  link="https://www.instagram.com/campbell.frost/"
                  bold={false}
                />
                <ContactMeButton />
              </div>
